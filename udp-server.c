...
// --- DEGISIKLIK 1: firmware_data.h dahil edildi ---
// Server artik firmware boyutunu dogrudan bu dosyadan okur.
// Boylece client ve server her zaman AYNI boyutu referans alir.
...
// --- DEGISIKLIK 2: Sabit 129760 degeri kaldirildi ---
// TOTAL_FIRMWARE_SIZE ve EXPECTED_BLOCKS artik firmware_data.h'daki
// FIRMWARE_PAYLOAD_LEN degerinden otomatik hesaplaniyor.
// Eski kod: #define TOTAL_FIRMWARE_SIZE 129760
// Eski kod: #define EXPECTED_BLOCKS ((TOTAL_FIRMWARE_SIZE + CHUNK_SIZE - 1) / CHUNK_SIZE)
         ...
         uint16_t datalen)
{
  ...
  if(received_packet->block_num == expected_block) {
      ...
      // MUHENDiSLiK NOTU: Contiki Coffee FS dosya isimleri maks 16 karakter destekler!
      ...
      // Ag gecikmesinden dolayi eski bir paket tekrar geldiyse, ACK'yi tekrar bas
